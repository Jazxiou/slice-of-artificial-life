...
def generate_act_obj_desc(act_game_object, act_desp, persona): 
  ...
  # Local models can occasionally return None/empty payloads for this prompt.
  # Keep planning robust by falling back to a generic object state phrase.
  try:
    response = run_gpt_prompt_act_obj_desc(act_game_object, act_desp, persona)

...
urlpatterns = [
    ...
    url(r"^livetown$", translator_views.livetown, name="livetown"),
    url(r"^livetown_snapshot/(?P<persona_name>[\w-]+)/$", translator_views.livetown_snapshot, name="livetown_snapshot"),
    url(r"^livetown_control/$", translator_views.livetown_control, name="livetown_control"),
